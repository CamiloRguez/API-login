...
<Project DefaultTargets="Build" ToolsVersion="14.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{CCDFFD89-9829-4B87-BA52-2B8AC9C37DCC}</ProjectGuid>
  ...
  <ItemDefinitionGroup Condition="'$(Configuration)|$(Platform)'=='Debug|x64'">
    <ClCompile>
      <AdditionalIncludeDirectories>C:\Users\Camilo\.node-gyp\7.0.0\include\node;C:\Users\Camilo\.node-gyp\7.0.0\src;C:\Users\Camilo\.node-gyp\7.0.0\deps\uv\include;C:\Users\Camilo\.node-gyp\7.0.0\deps\v8\include;%(AdditionalIncludeDirectories)</AdditionalIncludeDirectories>
    ...
    <Link>
      <AdditionalDependencies>kernel32.lib;user32.lib;gdi32.lib;winspool.lib;comdlg32.lib;advapi32.lib;shell32.lib;ole32.lib;oleaut32.lib;uuid.lib;odbc32.lib;DelayImp.lib;&quot;C:\Users\Camilo\.node-gyp\7.0.0\$(Configuration)\node.lib&quot;</AdditionalDependencies>
  ...
  <ItemGroup>
    <ClCompile Include="F:\BO TRUE\Aplicación Web\API\node_modules\node-gyp\src\win_delay_load_hook.cc"/>
  </ItemGroup>
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\bcrypt_lib.node">
      <FileType>Document</FileType>
      <Command>call mkdir &quot;F:\BO TRUE\AplicaciÃ³n Web\API\node_modules\bcrypt\lib\binding&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)bcrypt_lib.node&quot; &quot;F:\BO TRUE\AplicaciÃ³n Web\API\node_modules\bcrypt\lib\binding\bcrypt_lib.node&quot;&#xD;&#xA;if %errorlevel% neq 0 exit /b %errorlevel%</Command>
      <Message>Copying $(OutDir)/bcrypt_lib.node to F:/BO TRUE/AplicaciÃ³n Web/API/node_modules/bcrypt/lib/binding\bcrypt_lib.node</Message>
      <Outputs>F:\BO TRUE\AplicaciÃ³n Web\API\node_modules\bcrypt\lib\binding\bcrypt_lib.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="bcrypt_lib.vcxproj">
      <Project>{B84185BD-7067-9091-21DF-EEBC2ECEAFAA}</Project>
